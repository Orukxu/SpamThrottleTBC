...
Default_SpamThrottle_KeywordFilterList = { "Blessed Blade of the Windseeker", "item4game", "moneyforgames", "goldinsider", "sinbagame", "sinbagold", "sinbaonline", "susangame", "4gamepower", "iloveugold", "okogames", "item4wow", "gold4mmo", "wtsitem", "goldarius" }
...
function SpamThrottleMessage(visible, ...)
	local arg = {};
	local maxargs = 15;
	arg[1], arg[2], arg[3], arg[4], arg[5], arg[6], arg[7], arg[8], arg[9], arg[10], arg[11], arg[12], arg[13], arg[14], arg[15] = ...;
	
	for i = 1, maxargs do
		if type(arg[i]) == "nil" then
			-- just avoid nil arguments
...
function SpamThrottleConfigFrame_OnShow()
	...
	-- Good place to put test method since this code segment gets hit on /st
